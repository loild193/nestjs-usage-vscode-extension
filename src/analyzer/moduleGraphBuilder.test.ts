...
vi.mock('vscode', () => ({
    ...
    workspace: {
        ...
        asRelativePath: (uri: { fsPath: string } | string) => (typeof uri === 'string' ? uri : uri.fsPath),
    },
    Range: class Range {
        constructor(
...
`
            ...
            vi.mocked(vscode.workspace.findFiles).mockResolvedValueOnce([vscode.Uri.file('/app/user/user.module.ts')])
...
`
            ...
            vi.mocked(vscode.workspace.findFiles).mockResolvedValueOnce([vscode.Uri.file('/app/test.module.ts')])
